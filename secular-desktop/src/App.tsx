...
const DUMMY_SERVERS: ServerInfo[] = [
  {
    id: 'dummy-1',
    name: 'vps local',
    meta: '13.140.25.184:8443 / HTTP/2',
    isDefault: true,
    config: {
      address: '13.140.25.184:8443',
      hostname: '13.140.25.184',
      username: 'user1',
      password: 'pass1',
      upstream_protocol: 'http2',
      dns_upstreams: ['9.9.9.9', '149.112.112.112'],
  ...
  },
  {
    id: 'dummy-2',
    name: 'XCART',
    meta: '209.50.241.108:443 / HTTP/2',
    isDefault: false,
    config: {
      address: '209.50.241.108:443',
      hostname: '209.50.241.108',
      username: 'user2',
      password: 'pass2',
      upstream_protocol: 'http2',
      dns_upstreams: ['9.9.9.9', '149.112.112.112'],
  ...
  },
  {
    id: 'dummy-3',
    name: 'Tokyo Edge',
    meta: '103.21.244.1:443 / HTTP/2',
    isDefault: false,
    config: {
      address: '103.21.244.1:443',
      hostname: 'tokyo.edge.vpn',
      username: 'tokyo',
      password: 'tokyo123',
      upstream_protocol: 'http2',
  ...
  },
  {
    ...
    meta: '185.103.24.4:8443 / QUIC',
    isDefault: false,
    config: {
      address: '185.103.24.4:8443',
      hostname: 'frankfurt.relay.vpn',
      username: 'fra',
      password: 'fra456',
  ...
  },
  {
    id: 'dummy-5',
    name: 'Singapore Hub',
    meta: '104.16.123.96:443 / HTTP/2',
    isDefault: false,
    config: {
      address: '104.16.123.96:443',
      hostname: 'sg.hub.vpn',
      username: 'sg',
      password: 'sg789',
      upstream_protocol: 'http2',
  ...
  },
  {
    id: 'dummy-6',
    name: 'London Bridge',
    meta: '151.101.0.81:443 / HTTP/2',
    isDefault: false,
    config: {
      address: '151.101.0.81:443',
      hostname: 'lon.bridge.vpn',
      username: 'lon',
      password: 'lon101',
      upstream_protocol: 'http2',
      dns_upstreams: ['9.9.9.9', '149.112.112.112'],
  ...
  },
  {
    id: 'dummy-7',
    name: 'NYC Core',
    meta: '198.41.0.4:8443 / QUIC',
    isDefault: false,
    config: {
      address: '198.41.0.4:8443',
      hostname: 'nyc.core.vpn',
      username: 'nyc',
      password: 'nyc202',
      upstream_protocol: 'http3',
  ...
  },
  {
    id: 'dummy-8',
    name: 'Sydney Node',
    meta: '104.26.10.5:443 / HTTP/2',
    isDefault: false,
    config: {
      address: '104.26.10.5:443',
      hostname: 'syd.node.vpn',
      username: 'syd',
      password: 'syd303',
      upstream_protocol: 'http2',
      dns_upstreams: ['9.9.9.9', '149.112.112.112'],
  ...
  },
  {
    id: 'dummy-9',
    name: 'Toronto Gate',
    meta: '172.67.74.120:443 / HTTP/2',
    isDefault: false,
    config: {
      address: '172.67.74.120:443',
      hostname: 'tor.gate.vpn',
      username: 'tor',
      password: 'tor404',
      upstream_protocol: 'http2',
  ...
  },
  {
    id: 'dummy-10',
    name: 'Mumbai Proxy',
    meta: '104.21.55.201:8443 / QUIC',
    isDefault: false,
    config: {
      address: '104.21.55.201:8443',
      hostname: 'bom.proxy.vpn',
      username: 'bom',
      password: 'bom505',
      upstream_protocol: 'http3',
      dns_upstreams: ['9.9.9.9', '149.112.112.112'],
...
const App: React.FC = () => {
  ...
  // Append dummy test servers on first mount (in-memory, not from localStorage)
  const dummiesAppended = useRef(false);
  useEffect(() => {
    if (dummiesAppended.current) return;
    dummiesAppended.current = true;
    setServers(prev => {
      const dummyIds = new Set(DUMMY_SERVERS.map(d => d.id));
      const hasDummies = prev.some(s => dummyIds.has(s.id));
      return hasDummies ? prev : [...prev, ...DUMMY_SERVERS];
    });
  }, []);
